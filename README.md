...
- **500 人满频群聊**：支撑 500 并发长连接 100% 建连成功，消息下行吞吐达 11.2 万条 / 秒，HTTP 接口零失败，平均延迟 5.92ms；
- **万人大规模在线**：稳定支撑 10000 长连接在线、1000 人活跃，WS 建连平均耗时仅 2.45ms，接口 P95 延迟 9.48ms；
- **兼容安全加密**：开启密码加密后，仍可稳定承载万级在线，服务无雪崩、无断连；
- **资源表现**：服务资源占用合理，MySQL / 后端服务 CPU 稳定可控，满足生产级高并发 IM 场景要求。
